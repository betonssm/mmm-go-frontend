    ...
    >
      ...
      <div style={{ marginTop: "20px", padding: "20px", background: "rgba(0, 0, 0, 0.6)", borderRadius: "12px" }}>
        ...
        <ul style={{ listStyleType: "none", paddingLeft: "0" }}>
          <li><strong style={{ color: "#ffe082" }}>1. Фонд состоит из выплат от инвестиций и дохода от рекламы.:</strong> 30% донат, 60% рефералы, 10% активность.</li>
          <li><strong style={{ color: "#ffe082" }}>2. Фонд разделяется по итогам месяца среди топ 10% инвесторов.</strong></li>
          <li><strong style={{ color: "#ffe082" }}>3. Рейтинг инвесторов формируется исходя из количества баллов SR.</strong></li>
          <li><strong style={{ color: "#ffe082" }}>4. Чтобы участвовать в разделе фонда, инвестор должен быть активен минимум 22 дня в месяц..</strong></li>
        </ul>
      </div>
