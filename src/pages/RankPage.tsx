    ...
    >
      ...
      <div style={{ marginTop: "20px", padding: "20px", background: "rgba(0, 0, 0, 0.6)", borderRadius: "12px" }}>
        ...
        <ul style={{ listStyleType: "none", paddingLeft: "0" }}>
          <li><strong style={{ color: "#ffe082" }}>1. Фонд состоит из выплат от инвестиций и дохода от рекламы:</strong>инвестиций и дохода от рекламы</li>
          <li><strong style={{ color: "#ffe082" }}>2. Фонд разделяется по итогам месяца среди топ 10% инвесторов</strong>10% инвесторов</li>
          <li><strong style={{ color: "#ffe082" }}>3. Рейтинг инвесторов формируется исходя из количества баллов SR</strong>SR</li>
          <li><strong style={{ color: "#ffe082" }}>4. Чтобы участвовать в разделе фонда, инвестор должен быть активен минимум 22 дня в месяц.</strong>22 дня в месяц.</li>
        </ul>
      </div>
